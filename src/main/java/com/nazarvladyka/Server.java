...
public class Server {
    ...
    private static void write(SocketChannel writeSocketChannel) throws IOException {
    ...
    private static void read(SocketChannel readSocketChannel) throws IOException {
        ByteBuffer byteBuffer = ByteBuffer.allocate(50);
